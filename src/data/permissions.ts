...
export const ROLE_NAV_PERMISSIONS: Record<UserRole, Record<string, boolean>> = {
  Owner:   { dashboard: true, orders: true, discounts: true, products: true, models: true, stock: true, 'stock-movements': true, customers: true, reports: true, users: true, roles: true, permissions: true, activity: true, 'act-users': true, 'act-orders': true, 'act-products': true, 'act-stock': true, 'act-log': true, 'act-discounts': true, settings: true, payroll: true, deliveries: true, drivers: true },
  Manager: { dashboard: true, orders: true, discounts: true, products: true, models: true, stock: true, 'stock-movements': true, customers: true, reports: true, users: false, roles: false, permissions: false, activity: true, 'act-users': true, 'act-orders': true, 'act-products': true, 'act-stock': true, 'act-log': true, 'act-discounts': true, settings: false, payroll: true, deliveries: true, drivers: true },
  Staff:   { dashboard: true, orders: true, discounts: false, products: false, models: false, stock: false, 'stock-movements': false, customers: true, reports: false, users: false, roles: false, permissions: false, activity: false, 'act-users': false, 'act-orders': false, 'act-products': false, 'act-stock': false, 'act-log': false, 'act-discounts': false, settings: false, payroll: false, deliveries: true, drivers: false },
  Viewer:  { dashboard: true, orders: false, discounts: false, products: false, models: false, stock: false, 'stock-movements': false, customers: false, reports: true, users: false, roles: false, permissions: false, activity: false, 'act-users': false, 'act-orders': false, 'act-products': false, 'act-stock': false, 'act-log': false, 'act-discounts': false, settings: false, payroll: false, deliveries: false, drivers: false },
}
